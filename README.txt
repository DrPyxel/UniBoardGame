...
The player will be presented with a piece of paper, and on it are several questions. The player can get a certain number of points by getting answers right. When you think you have an answer, hit the space bar. If it is right it will take you to the gameboard. If not you will have to keep inputing numbers until its right. If the answer in negative, refresh the page. 

French: Make a Crêpe (Color: Orange. ALL FOREIGN LANGUAGES ARE RED NO MATTER WHAT)
...
Spanish: Taco Catch (Color: Purple)
